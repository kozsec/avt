...
[mask time=10]
[bg  storage="IMAGE/Gemini_Generated_Image_girx4igirx4igirx.png"  time="10"  method="fadeIn"  ]
[playbgm  volume="40"  time="1000"  loop="true"  storage="MUSIC/bg1.mp3"  ]
[tb_show_message_window] 
[chara_show  name="Movi"  time="10"  wait="true"  storage="chara/2/Gemini_Generated_Image_dlviyvdlviyvdlvi.png"  width="603"  height="603"  left="413"  top="41"  reflect="false"  ]
[mask_off time=10]
...
イエには何もないだろ。[p]
#
朝から俺はモヴィと行き先を相談している。どうせなら一泊しようと考えていたが、そもそもプランが浮かばない。[p]
一人分の料金で済むし、少しくらい贅沢したって良いと思っていたが、どうも俺はプライベートだと優柔不断になってしまう。[p]
#あなた
特定の場所じゃなくても、何か興味があることはないのか。[p]
#movi
・・・昨日見たキラキラした世界には興味があります。[p]
#
「キラキラ」というキーワードが出た。今は夏だし、海でも、山でも、川でも、キラキラした美しいものが見れるとは思う。家は論外だ。[p]
ここはいっそ、俺が決めてしまうか。[p]
[_tb_end_text]
...
[tb_start_text mode=1 ]
#
残念ながら溪谷下りには参加できなかった。[p]
やはりパソコンを持って歩くと自由な活動が制限されてしまう。[p]
#あなた
すまない。私のリサーチ不足だった。[p]
#movi
[_tb_end_text]
