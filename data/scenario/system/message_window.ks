;メッセージレイヤの定義
		...
		[position width=920 height=211 top=369 left=NaN ]
		...
		[ptext name="chara_name_area" layer="message0" color=0xFFFFFF size=26 x=100 y=379 bold="bold" edge="undefined" shadow="undefined"]
		...
		[position layer="message1" width=920 height=211 top=369 left=NaN ]
